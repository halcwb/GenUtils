...
[<assembly: AssemblyTitleAttribute("Informedica.GenUtils.Tests")>]
[<assembly: AssemblyProductAttribute("Informedica.GenUtils")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Informedica.GenUtils.Tests"
    let [<Literal>] AssemblyProduct = "Informedica.GenUtils"
